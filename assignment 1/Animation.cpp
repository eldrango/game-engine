...
Animation::Animation(SDL_Texture* spriteSheet, SDL_Renderer* renderer, int numberOfFrames, int spriteX, int spriteY, int frameWidth, int frameHeight, float frameDuration) {
